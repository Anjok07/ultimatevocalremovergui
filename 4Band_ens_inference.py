...
def main():
    ...
    p.add_argument('--pretrained_modelE', '-E', type=str, default='models/BigLayer_4band_1.pth') ##DON'T CHNGE
    p.add_argument('--pretrained_modelF', '-F', type=str, default='models/BigLayer_4band_2.pth') ##DON'T CHNGE
    p.add_argument('--pretrained_modelG', '-G', type=str, default='models/BigLayer_4band_3.pth') ##DON'T CHNGE
...
####################################################-ENSEMBLING-BEGIN-#######################################################
    ...
    if args.deepextraction:
        ...
        os.system("python lib/spec_utils.py -a min_mag -m modelparams/1band_sr44100_hl512.json ensembled/temp/7_BigLayer_4band_3_Instruments.wav ensembled/temp/A6_ensam5_v.wav -o ensembled/temp/Complete")
        ...
        os.system("python lib/spec_utils.py -a max_mag -m modelparams/1band_sr44100_hl512.json ensembled/temp/7_BigLayer_4band_3_Vocals.wav ensembled/temp/A6V_ensam5_v.wav -o ensembled/temp/CompleteV")
        ...
        os.rename('ensembled/temp/subtracted-difftemp_v.wav', 'ensembled/{}_4BAND_Ensembled_DeepExtraction_Instrumental.wav'.format(basename))
